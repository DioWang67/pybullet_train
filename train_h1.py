...
MODEL_PATH   = os.path.join(MODEL_DIR, "h1_sac")
...
def train(resume: bool = False):
    ...
    model.learn(
        ...
        callback=[
            ...
            TrainingProgressCallback(total_timesteps),
            CheckpointCallback(save_freq=100_000, save_path=MODEL_DIR,
                               name_prefix="h1"),
            EvalCallback(eval_vec, best_model_save_path=MODEL_DIR,
